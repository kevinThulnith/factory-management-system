...
export const blacklistToken = (refresh) =>
  api.post("/token/blacklist/", { refresh });
...
export const createSkill = (data) => api.post("/skill-matrix/", data);
export const getSkillDetail = (id) => api.get(`/skill-matrix/${id}/`);
export const updateSkill = (id, data) => api.put(`/skill-matrix/${id}/`, data);
export const deleteSkill = (id) => api.delete(`/skill-matrix/${id}/`);
